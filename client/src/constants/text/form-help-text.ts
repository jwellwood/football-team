...
export const targetsFormHelper: string =
  'Set your personal targets for the season. You can set these at any time unless admin disables this option. You can set targets between 0-100';
